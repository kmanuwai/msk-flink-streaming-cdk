    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        lambdaFn = lambda_.Function(
            ...
            environment={'topicName':'kfp_sensor_topic',
                         'mskClusterArn':msk_cluster.cluster_arn},#attr_arn},
            vpc=vpc,
            vpc_subnets=ec2.SubnetSelection(subnet_type=ec2.SubnetType('PRIVATE_WITH_EGRESS')),
            role=lambda_role,
        ...
        flink_app = flink.Application(self, "App",
            ...
            property_groups=
            {
               ...
               "producer.config.0" : {
                    ...
                    "bootstrap.servers": msk_cluster.bootstrap_brokers
                },
                "consumer.config.0": {
        ...
        # IAM: Grant Apache Flink access to read and write to output bucket
